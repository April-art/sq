        ...
        <router-link to="/love">
            ...
            <mt-swipe :auto="4000" >
                <mt-swipe-item>
                    ...
                    <img src="../.././assets/images/young/1.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                   
                       <img src="../.././assets/images/young/2.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                  
                       <img src="../.././assets/images/young/3.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                    
                       <img src="../.././assets/images/young/4.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                    
                       <img src="../.././assets/images/young/5.jpg" alt="">
                </mt-swipe-item>
            </mt-swipe>
            <div class="recommend_container">
                ...
                <v-touch v-on:swipeleft="swiperleft" :swipe-options="{direction: 'horizontal'}" v-on:swiperight="swiperright" class="love_ranking" ref='abc'>
                    ...
                    <div class="l_rangking">
                        <div class="title_dmtj">
                            <div class="dm_title">
                                <div class="recentlytext">少年类排行</div>
                                <div class="more">更多
               ...
               <div class="Love_health">
                    <div class="title_dmtj">
                        <div class="dm_title">
                            <div class="recentlytext">小咚推荐</div>
                            <div class="more">更多
                                <span class="glyphicon glyphicon-chevron-right"></span>
                            </div>
                        </div>
                        ...
                        <div class="lh_content">
                            <div class="dmtj" v-for="(key,index) in result5" :key="index">
                                <!-- 图片 -->
                                <div class="dmtj_img">
                ...
                <div class="fantastic">
                    <div class="title_dmtj">
                        <div class="recently_title">
                            <div class="recentlytext">精品 一秒带你入坑</div>
                            <div class="more">更多
                                <span class="glyphicon glyphicon-chevron-right"></span>
                            </div>
                        </div>
                        ...
                        <div class="fw_content">
                            <div class="fw" v-for="(key,index) in result4" :key="index">
                                <!-- 图片 -->
                                <div class="fw_img">
...
export default {
    ...
    methods:{
          //get 请求 少年类的动漫
         getrequest1(){
            this.$axios.get('http://api.pingcc.cn/?name=少年类').then((result)=>{
       ...
       //get 请求 精品类的动漫
         getrequest2(){
            this.$axios.get('http://api.pingcc.cn/?name=精品类动漫').then((result)=>{
       ...
       //get 请求 小咚推荐的动漫
         getrequest3(){
            this.$axios.get('http://api.pingcc.cn/?name=甜甜类动漫').then((result)=>{
                // console.log(result.body.mhlist)
                for(var i=0;i<6;i++){
       ...
       //get 请求 完结的动漫
         ...
         swiperleft: function () {
            if(this.a <= -2){
                // this.a == -3
                this.$router.push({'path':'/find/campus'});
                // console.log(this.a);
            }else if( this.a == -2){
                this.a = this.a - 1
        ...
        swiperright: function () {
            if(this.a == 0){
               this.a = this.a + 1
                $('.ranking_container').animate({'left':this.a * this.b + '%'})
                 this.$router.push({'path':'/find/love'});
            }else{
                this.a = this.a + 1
                $('.ranking_container').animate({'left':this.a * this.b + '%'})
                 // ts.style.left = +'100%';
