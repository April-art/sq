        ...
        <router-link to="/love">
            ...
            <mt-swipe :auto="4000" >
                ...
                <mt-swipe-item>
                     ...
                     <img src="../.././assets/images/campus/2.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                   
                     <img src="../.././assets/images/campus/3.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                    
                     <img src="../.././assets/images/campus/4.jpg" alt="">
                </mt-swipe-item>
                <mt-swipe-item>
                   
                     <img src="../.././assets/images/campus/5.jpg" alt="">
                </mt-swipe-item>
            </mt-swipe>
            <div class="recommend_container">
                ...
                <v-touch v-on:swipeleft="swiperleft" :swipe-options="{direction: 'horizontal'}" v-on:swiperight="swiperright" class="love_ranking" ref='abc'>
                    ...
                    <div class="l_rangking">
                        <div class="title_dmtj">
                            <div class="dm_title">
                                <div class="recentlytext">校园类排行</div>
                                <div class="more">更多
               ...
               <div class="Love_health">
                    <div class="title_dmtj">
                        <div class="dm_title">
                            <div class="recentlytext">青春有你才美好</div>
                            <div class="more">更多
                                <span class="glyphicon glyphicon-chevron-right"></span>
                            </div>
                        </div>
                ...
                <div class="fantastic">
                    <div class="title_dmtj">
                        <div class="recently_title">
                            <div class="recentlytext">这是什么神仙友情?</div>
                            <div class="more">更多
                                <span class="glyphicon glyphicon-chevron-right"></span>
                            </div>
                        </div>
...
export default {
    ...
    methods:{
         //get 请求 校园类的动漫
         getrequest1(){
            this.$axios.get('http://api.pingcc.cn/?name=校园类').then((result)=>{
       ...
       //get 请求 青春有你才美好的动漫
         getrequest2(){
            this.$axios.get('http://api.pingcc.cn/?name=青春类').then((result)=>{
                // console.log(result.data.mhlist)
                for(var i=0;i<6;i++){
       ...
       //get 请求 这是什么神仙友情的动漫
         getrequest3(){
            this.$axios.get('http://api.pingcc.cn/?name=友情').then((result)=>{
                // console.log(result.data.mhlist)
                for(var i=0;i<4;i++){
